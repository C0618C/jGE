...
class $tk_path extends $$tk_base{
    constructor({styleType=null,style=null,points=null,pos=[0,0],update=null}={}){
...
class $tk_ellipse extends $$tk_base{
    constructor({styleType=null,style=null,points=null,pos=[0,0],update=null,a=0,b=0,r=0}={}){
...
class $tk_font extends $$tk_base{
    constructor({text="Text Unset",styleType="fill",style=null,font="22px 微软雅黑",angle=0,pos=[0,0],update=null}){
        super({styleType:styleType,style:style,pos:pos,update:update});
        this.font = font;
