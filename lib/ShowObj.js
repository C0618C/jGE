...
//图像精灵
class $tk_sprit{
    constructor({img=null,pos=[0,0],area={width:img.width,height:img.height},sarea=null}={}){
...
//视频部件
class $tk_video extends $tk_sprit{
    constructor(setting){
...
//动画部件
class $tk_animation extends $tk_sprit{
    /*
        入参说明：area是当前图片的可视区，当多组sprite在同一个图片时，用于限定当前组的范围。
